...
<?php global $hideFooter; if (!$hideFooter) { ?>
        <footer class="u-align-center u-clearfix u-footer u-palette-3-base u-footer" id="sec-ae95">
  <div class="u-clearfix u-sheet u-sheet-1">
    <p class="u-small-text u-text u-text-variant u-text-1">by. <span style="font-weight: 700; font-size: 1.125rem;">Ellene&nbsp;</span>
      <br>This Page made for School Assigment Only 
    </p>
  </div>
</footer>
